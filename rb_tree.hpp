...
/*   Updated: 2022/05/31 19:54:26 by mwen             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		ft::pair<iterator, iterator>				equal_range(const key_type& __k)
		{
			...
			while (__x)
			{
				...
				else
				{
					...
					__y = __x, __x = _S_left(__x);
					__xu = _S_right(__xu);
					return ft::pair<iterator, iterator>(_M_lower_bound(__x, __y, __k), _M_upper_bound(__xu, __yu, __k));
				}
			}
		...
		ft::pair<const_iterator, const_iterator>	equal_range(const key_type& __k) const
		{
			...
			while (__x)
			{
				...
				else
				{
					...
					__y = __x, __x = _S_left(__x);
					__xu = _S_right(__xu);
					return ft::pair<const_iterator, const_iterator>(_M_lower_bound(__x, __y, __k), _M_upper_bound(__xu, __yu, __k));
				}
			}
